            ...
            try:
                ...
                if cmd in ["q", "exit"]: 
                    ...
                    help_text = (f"\n{BOLD}Available Commands:{RESET}\n"
                                 ...
                                 f"  {BOLD}iz{RESET} [filter] : Extract raw ASCII strings with localized Auto-C injection\n"
                                 f"  {BOLD}asmd{RESET} [size] : Transpile active block to static pseudo-C code via constant lambda maps\n"
